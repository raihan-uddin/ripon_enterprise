...
// application components
    'components' => array(
        ...
        'db' => array(
            ...
            'connectionString' => 'mysql:host=localhost;dbname=u582684567_accounting',
            'emulatePrepare' => true,
            //'username' => 'root',
            'username' => 'u582684567_accounting',
            'password' => '5Z/oeHFq;Z',
            //'password' => '',
            'charset' => 'utf8',
            'tablePrefix' => '',
...
// this is used in contact page
        'dbName' => 'erp',
        'servername' => 'Pulse Tech Ltd.',
        'serverhost' => 'abcd',
        'adminEmail' => 'info@abcd.com',
        'copyrightBy' => date('y'),
        'developedBy' => 'Pulse Tech Ltd',
        'developedByUrl' => 'https://www.pulsetechltd.com/',
    ),
);
