...
//             'title' => 'Report generated by: '.Yii::app()->user->name. ' ' . ' =====  ' .Yii::app()->name.'',
            ...
            $po = PurchaseOrder::model()->findByPk($data->purchase_order_id);
            ?>
        </div>
        <div class='printAllTableForThisReport' style="width: 8.5in;">
            <table style="width: 100%; border-collapse: collapse; font-size: 11px;" class="item-list">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
                            <tr>
                                <td style="text-align: center;"><b>Rcv. No</b></td>
                                <td style="text-align: center;"><b>Rcv. Date</b></td>
                            </tr>
                            <tr>
                                <td style="text-align: center;"><?= $data->receive_no ?></td>
                ...
                <tr>
                    ...
                    <td style="text-align: center;  width: 10%;" colspan="2">Code</td>
                    <td style="text-align: center;  width: 10%;">Receive Qty</td>
                </tr>
                <tbody>
                <?php
