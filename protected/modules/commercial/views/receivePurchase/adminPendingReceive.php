...
$this->widget('application.components.BreadCrumb', array(
    'crumbs' => array(
        ...
        array('name' => 'Receive', 'url' => array('admin')),
        array('name' => 'Pending Receive'),
    ),
//    'delimiter' => ' &rarr; ',
));
?>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Preview Pending Order</h3>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Manage Pending Order</h3>
    ...
    <div class="card-body">
        <?php $this->widget('ext.groupgridview.GroupGridView', array(
            'id' => 'sell-order-grid',
            'dataProvider' => $model->searchPendingReceive(),
            'filter' => $model,
...
//                'max_sl_no',
                ...
                (
                    ...
                    'buttons' => array(
                        'receive' => array(
                            'label' => '<i class="fa fa-download fa-2x" style="color: green;"></i>&nbsp;&nbsp;',
                            'options' => array('rel' => 'tooltip', 'data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Receive'), 'class' => 'delivery-icon'),
                            'imageUrl' => false,
                            'url' => 'Yii::app()->controller->createUrl("receivePurchase/receive",array("id"=>$data->id))',
//                            'click' => "function( e ){
//                                e.preventDefault();
