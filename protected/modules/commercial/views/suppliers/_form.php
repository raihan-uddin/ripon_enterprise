...
<style>
/* ── Supplier Form : Indigo Palette ── */
.su-card{border:none;border-radius:16px;overflow:hidden;box-shadow:0 4px 6px rgba(0,0,0,.04),0 12px 36px rgba(0,0,0,.10);margin-bottom:24px}
.su-card-header{background:linear-gradient(135deg,#4f46e5 0%,#7c3aed 100%);padding:20px 26px;position:relative;overflow:hidden}
...
.su-header-row{display:flex;align-items:center;gap:14px;position:relative;z-index:1}
.su-header-icon{width:32px;height:32px;border-radius:9px;background:rgba(255,255,255,.2);display:flex;align-items:center;justify-content:center;color:#fff;font-size:15px;flex-shrink:0}
...
.su-card-body{padding:22px 26px;background:#fff}
.su-card-footer{background:#f8fafc;border-top:1px solid #f1f5f9;padding:14px 26px;display:flex;align-items:center;gap:10px}

/* ── Floating label fields ── */
.su-fl{position:relative;margin-bottom:20px}
...
.su-fl textarea.su-fl-input{min-height:80px;resize:vertical}
...
.su-fl--ta .su-fl-label{top:20px;transform:none}
.su-fl--ta .su-fl-icon{top:20px;transform:none}
...
/* ── Grid helpers ── */
.su-row{display:flex;flex-wrap:wrap;gap:0 20px}
.su-col-4{flex:0 0 calc(33.333% - 14px);max-width:calc(33.333% - 14px)}
.su-col-6{flex:0 0 calc(50% - 10px);max-width:calc(50% - 10px)}
.su-col-12{flex:0 0 100%;max-width:100%}
@media(max-width:991px){.su-col-4{flex:0 0 calc(50% - 10px);max-width:calc(50% - 10px)}}
