    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-lg-4">
                ...
                <?php echo $form->dropDownList($model, 'company_id', CHtml::listData(Customers::model()->findAll(array('order' => 'company_name ASC')), 'id', 'company_name'), array('prompt' => 'Select', 'class' => 'form-control'));?>
