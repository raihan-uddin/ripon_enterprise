...
$this->widget('application.components.BreadCrumb', array(
    'crumbs' => array(
        ...
        array('name' => 'Customers', 'url' => array('admin')),
        array('name' => 'Customer Contact Person'),
    ),
//    'delimiter' => ' &rarr; ',
));
?>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Manage Contact Persons (Customer's)</h3>
...
//            ),
            ...
            'columns' => array(
                array(
                    'name' => 'company_id',
                    'value' => 'Customers::model()->nameOfThis($data->company_id)',
