...
$this->widget('application.components.BreadCrumb', [
    'crumbs' => [
        ['name' => 'Sales', 'url' => ['admin']],
        ['name' => 'Collection', 'url' => ['admin']],
        ['name' => 'Create'],
    ],
]);
...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-primary text-white">
            <h5 class="card-title"><?= $model->isNewRecord ? 'Create Money Receipt' : 'Update Money Receipt' ?></h5>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <?= $form->textField($model, 'customer_name', [
                                'class' => 'form-control',
                                'readonly' => true,
                        ...
                        <?= $form->error($model, 'customer_id', ['class' => 'text-danger']) ?>
                    </div>

                    <div class="form-group">
                        <?= $form->labelEx($model, 'received_by') ?>
                        <div class="input-group">
                            <?= $form->textField($model, 'received_by', [
                                'class' => 'form-control',
                                'readonly' => true,
                        ...
                        <?= $form->error($model, 'received_by', ['class' => 'text-danger']) ?>
                    </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            $criteria->addColumnCondition(['customer_id' => $model2->id]);
                            $sellOrder = SellOrder::model()->findByAttributes([], $criteria);
                            $totalSellAmount = $sellOrder ? $sellOrder->grand_total : 0;
                            ...
                            $criteria->addColumnCondition(['customer_id' => $model2->id]);
                            $moneyReceipt = MoneyReceipt::model()->findByAttributes([], $criteria);
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="remaining_due_amt" name="remaining_due_amt" disabled>
                            <div class="input-group-append">
                                <span class="input-group-text"><i class="fa fa-balance-scale"></i></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group bank-group d-none" id="bank_section">
                        ...
                        <div class="input-group">
                            <?= $form->dropDownList($model, 'bank_id',
                                CHtml::listData(CrmBank::model()->findAll(['order' => 'name ASC']), 'id', 'name'),
         ...
         <div class="card-footer text-right">
            ...
            echo CHtml::ajaxSubmitButton('Create', CHtml::normalizeUrl(array('/accounting/moneyReceipt/create', 'id' => $id, 'render' => true)), array(
                ...
                'beforeSend' => 'function(){  
                        ...
                        let row_amounts = parseFloat($("#MoneyReceipt_amount").val());
                        let row_discount = parseFloat($("#MoneyReceipt_discount").val());
                        ...
                        if (total_mr == 0){
                            $("#MoneyReceipt_amount").addClass("is-invalid");
                            $("#MoneyReceipt_discount").addClass("is-invalid");
                        }
                        else {
                            $("#MoneyReceipt_amount").removeClass("is-invalid");
                            $("#MoneyReceipt_discount").removeClass("is-invalid");
                        }
                        if(date == ""){
...
<script>
    $(document).ready(function() {
        ...
        $('#MoneyReceipt_amount, #MoneyReceipt_discount').on('input', function () {
            ...
            let amount = parseFloat($('#MoneyReceipt_amount').val()) || 0;
            let discount = parseFloat($('#MoneyReceipt_discount').val()) || 0;
