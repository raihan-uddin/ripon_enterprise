...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title"><?php echo($model->isNewRecord ? 'Add New Expense Head' : 'Update Expense Head: ' . $model->title); ?></h3>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <?php echo $form->dropDownList($model, 'status', [ExpenseHead::ACTIVE => 'ACTIVE', ExpenseHead::INACTIVE => 'INACTIVE'], array('class' => 'form-control',)); ?>
                <span class="help-block"
