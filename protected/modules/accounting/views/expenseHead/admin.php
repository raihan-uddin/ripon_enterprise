...
<style>
    ...
    /* ── Filter row inputs ── */
    #expense-head-grid .filters input,
    #expense-head-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #expense-head-grid .filters input:focus,
    #expense-head-grid .filters select:focus {
        border-color: #17a2b8;
    ...
    /* ── Grid rows ── */
    #expense-head-grid td {
        vertical-align: middle;
        font-size: 13px;
        padding: 7px 10px;
    }

    #expense-head-grid tr:hover td {
...
//                'id',
                ...
                array(
                    'name' => 'status',
                    'type' => 'raw',
                    'value' => 'ExpenseHead::model()->statusString($data->status)',
                    'filter' => [ExpenseHead::ACTIVE => 'ACTIVE', ExpenseHead::INACTIVE => 'INACTIVE'],
                    'htmlOptions' => ['class' => 'text-center']
                ),
...
function goToPage() {
    ...
    $.fn.yiiGridView.update('expense-head-grid', { data: { 'expense-head-grid_page': page } });
    $('#goto-page-input').val('');
}
