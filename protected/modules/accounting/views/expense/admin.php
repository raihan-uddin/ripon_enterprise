...
<style>
    ...
    /* ── Filter row inputs ── */
    #expense-grid .filters input,
    #expense-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #expense-grid .filters input:focus,
    #expense-grid .filters select:focus {
        border-color: #17a2b8;
...
//                'max_sl_no',
                ...
                array(
                    'name'        => 'entry_no',
                    'type'        => 'raw',
                    'value'       => 'CHtml::tag("span", ["class"=>"so-pill", "onclick"=>"copySoNo(this)", "title"=>"Click to copy"], CHtml::encode($data->entry_no))',
...
function goToPage() {
    ...
    $.fn.yiiGridView.update('expense-grid', { data: { 'expense-grid_page': page } });
    $('#goto-page-input').val('');
}
