...
<style>
    ...
    /* ── Filter row inputs ── */
    #payment-receipt-grid .filters input,
    #payment-receipt-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #payment-receipt-grid .filters input:focus,
    #payment-receipt-grid .filters select:focus {
        border-color: #17a2b8;
    ...
    /* ── Grid rows ── */
    #payment-receipt-grid td {
        vertical-align: middle;
        font-size: 13px;
        padding: 7px 10px;
    }

    #payment-receipt-grid tr:hover td {
...
//                'id',
                ...
                array(
                    'name'        => 'pr_no',
                    'type'        => 'raw',
                    'value'       => 'CHtml::tag("span", ["class"=>"so-pill", "onclick"=>"copySoNo(this)", "title"=>"Click to copy"], CHtml::encode($data->pr_no))',
