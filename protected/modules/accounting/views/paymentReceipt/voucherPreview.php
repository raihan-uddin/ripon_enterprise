...
<div class="card card-success">
    ...
    <div class="card-body">
        <div style="width: 100%">
            ...
            $this->widget('ext.mPrint.mPrint', array(//             'title' => 'Report generated by: '.Yii::app()->user->name. ' ' . ' =====  ' .Yii::app()->name.'',
                'title' => ' ', //the title of the document. Defaults to the HTML title
                'tooltip' => 'Print', //tooltip message of the print icon. Defaults to 'print'
                'text' => '', //text which will appear beside the print icon. Defaults to NULL
                'element' => '.printAllTableForThisReport', //the element to be printed.
                'exceptions' => array(//the element/s which will be ignored
                    '.summary', '.search-form', '#excludeDiv',), 'publishCss' => FALSE, //publish the CSS for the whole page?
                        ...
                        <td>
                            ...
                            <div style="width: 100%; float: left; clear: right;">
                                ...
                                <div style="width: 30%; height: 55px; float: left; clear: right; vertical-align: bottom; text-align: right;">
                                    <div style="width: 100%; float: left; clear:right;">
                                        <b style="font-size: 14px; line-height: 30px; letter-spacing: 2px"><?= $dt->pr_no; ?></b>
                                    </div>
                                    <div style="width: 100%; float: left; clear:right;">
                                        Date <span
                            ...
                            <div style="width: 100%; float: left; clear: right;">
                                <div class="mr-row" style="padding-top: 22px; float: left; clear: right; width: 100%;">
                                    ...
                                    <div style="width: 57%; float: left; clear: right; border-bottom: 1px dotted black;">
                                        &nbsp;&nbsp;&nbsp;<?= Suppliers::model()->nameOfThis($dt->supplier_id) ?>&nbsp;&nbsp;&nbsp;
                                    </div>
                                ...
                                <div class="mr-row" style="padding-top: 20px; float: left; clear: right; width: 100%;">
                                    ...
                                    <div style="width: 78%; float: left; clear: right; border-bottom: 1px dotted black; text-align: center;">
                                        &nbsp;&nbsp;&nbsp;<?= ComBank::model()->nameOfThis($dt->bank_id) ?>&nbsp;&nbsp;&nbsp;
                                    </div>
