        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-xs-12 col-sm-6 col-lg-4">
                    ...
                    <input type="text" id="fg_model_id_text" class="form-control" readonly value="<?= $model_name ?>">
...
//                                    'class' => '',
                    ...
                    <div class="row">
                        <div class="table table-responsive">
                            <table class="table table-bordered table-striped" id="list">
                                ...
                                $criteria->select = "t.*, pm.model_name, pm.code, pm.image, pm.unit_id as pm_unit_id";
                                ...
                                foreach ($bom2 as $b) {
                                    ...
                                    <tr class="item">
                                        ...
                                        <td class="text-center"
                                            style="display:none;"><?= Units::model()->nameOfThis($b->unit_id) ?></td>
                                        <td>
                                            <div class="input-group">
                                                <input type="text" class="form-control text-center"
                                                       value="<?= $b->qty ?>"
                                                       name=BomDetails[temp_qty][]"">
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><?= Units::model()->nameOfThis($b->pm_unit_id) ?></span>
                                                </div>
                                            </div>
                                            <input type="hidden" class="form-control" value="<?= $b->model_id ?>"
                                                   name="BomDetails[temp_model_id][]">
                                            <input type="hidden" class="form-control" value="<?= $b->unit_id ?>"
                                                   name="BomDetails[temp_unit_id][]">
                                        </td>
                                        <td>
        ...
        <div class="card-footer">
            <?php
            echo CHtml::ajaxSubmitButton('Update', CHtml::normalizeUrl(array('/production/bom/update/id/' . $model->id, 'render' => true)), array(
                'dataType' => 'json',
                'type' => 'post',
                'success' => 'function(data) {
                $("#ajaxLoader").hide();  
