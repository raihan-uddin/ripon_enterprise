...
<div class="formDiv">
    <fieldset>
        <legend>Upload Device File <font color="red">(Please upload only Excel 97-2003 Workbook(*.xls))</font></legend>
        <table>	
            <tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo CHtml::link('Process', array('/empAttendance/processDeviceData'), array('class'=>'additionalBtn')); ?>
                </td>
            </tr>
        </table>
    </fieldset>
