        ...
        <table> 
            ...
            <tr>
                ...
                <td>
                    ...
                    <script>
                        ...
                        $("#resetBtnSub").click(function( event ) {
                            $('.cardList input[type="checkbox"]').each(function() {
                                if ($(this).is(":checked")) {
                                    $(this).prop( "checked", false );
                                    $(this).next('span').css({"color":"#008b8b", "font-weight":"normal"});
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php
                    echo $form->dropDownList(
                        $model, 'sub_department_id', CHtml::listData(DepartmentsSub::model()->findAll(), 'id', 'title'), array(
                        'prompt' => 'Search Sub Department Wise',
                        'ajax' => array(
                            'dataType' => 'json',
                            'type' => 'POST',
                            'url' => CController::createUrl('employees/EmpIDNoOfThisDeptSub'),
                            'beforeSend' => 'function(){
                                $(".empList").html("");
                                document.getElementById("empList").style.background="url(' . Yii::app()->theme->baseUrl . '/images/ajax-loader-big_trans.gif) no-repeat #FFFFFF center center";
                            }',
                    ...
                    <div id="empList" class="empList" style="width: 1160px; float: left; overflow: scroll; height: 500px; border: 1px solid #d2d2d2;">
                        ...
                        <?php if ($data) { ?>
                            ...
                            <?php foreach ($data as $d) { ?>
                                <div class="cardList">
                                    <input class="empChckBxLst" type="checkbox" id="EmpShiftAsign_card_no_<?php echo $i++; ?>" name="EmpShiftAsign[emp_id][]" value="<?php echo $d->id; ?>"/><span><?php echo $d->full_name . " (" . $d->device_id . ")"; ?></span>
                                </div>
                            <?php } ?>
                        <?php } ?>
                    </div>
