        ...
        <table cellpadding="2">   
                        ...
                        $(function () {
                            $("#emp_id").autocomplete({
                                source: function (request, response) {
                                    ...
                                    $.post('<?php echo Yii::app()->baseUrl ?>/index.php/hr_payroll/employees/jqueryEmpSearch', {"emp_name": emp_name},
                                            function (data) {
                                                response(data);
                                            }, "json");
                                },
                                ...
                                select: function (event, ui) {
                                    ...
                                    $("#designation_name").val(ui.item.designation_name);
                                    $("#LhAmountProllNormal_designation_id").val(ui.item.designation_id);
                                    $("#department_name").val(ui.item.department_name);
									$("#LhAmountProllNormal_department_id").val(ui.item.designation_id);
									$("#LhAmountProllNormal_start_from").val(ui.item.permanentDate);
                                    return false;
                                }
                            });
                        });
            ...
            <tr>
          	...
          	<tr>
                ...
                <td>
				<input type="text" id = "designation_name" />
				<?php echo $form->hiddenField($model, 'designation_id', array('maxlength' => 255, 'readonly'=>'true')); ?>
				</td>
         	</tr>
            <tr>
				...
				<?php echo $form->hiddenField($model, 'department_id', array('maxlength' => 255, 'readonly'=>'true')); ?>
				</td>            
         	</tr>
            <tr>
