...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title"><?php echo($model->isNewRecord ? 'Add New Department' : 'Update Department'); ?></h3>
    ...
    <div class="card-footer">
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('/hr/departments/create', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
