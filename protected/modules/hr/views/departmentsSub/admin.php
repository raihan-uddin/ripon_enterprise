...
if (Yii::app()->user->checkAccess('Hr.SubDepartments.Create')) {
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Manage Sub-Department</h3>
...
//            'template' => "{pager}{summary}{items}{summary}{pager}",
            'columns' => array(
                array(
                    'name' => 'department_id',
                    'value' => 'CHtml::encode(Departments::model()->nameOfThis($data->department_id))',
...
?>
<div id="ajaxLoaderUpdate" style="display: none;"><img
