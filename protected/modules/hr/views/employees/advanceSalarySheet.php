...
?>
<fieldset>
    <legend>Generate Advance Salary Sheet</legend>
            ...
            <td colspan="2">
                ...
                echo CHtml::submitButton('Generate', array(
                    'ajax' => array(
                        'dataType' => 'json',
                        'type' => 'POST',
                        'url' => CController::createUrl('employees/advanceSalarySheetView'),
                        'beforeSend' => 'function(){
...
<fieldset>
    <legend>Advance Salary Sheet <div class="ajaxLoaderResultView" style="display: none; float: right;"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/ajax-loader.gif" /></div></legend>
