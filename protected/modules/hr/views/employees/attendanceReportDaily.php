...
<fieldset>
    ...
    <table class="summaryTab">
        <tr>
            <td width="12%"><?php echo $form->labelEx($model, 'startDate'); ?></td>
            <td width="12%"><?php echo $form->labelEx($model, 'endDate'); ?></td>
            <td width="12%"><?php echo $form->labelEx($model, 'department_id'); ?></td>
            <td width="12%"><label>Status</label></td>
            <td width="12%"><?php echo $form->labelEx($model, 'emp_id_no'); ?></td>
            <td width="12%"><?php echo $form->labelEx($model, 'id_no'); ?></td>
        ...
        <tr>
            ...
            <td>
                <?php
					$array = array('1' => 'P', '2' => 'PL', '3' => 'A');
					echo $form->dropDownList($model, 'p_status', $array, array(
						'prompt' => 'Select',
						'style' => "width:120px;",
					));
            	?>
            ...
            <td colspan="2">
                ...
                echo CHtml::submitButton('Generate', array(
                    'ajax' => array(
                        'dataType' => 'json',
                        'type' => 'POST',
                        'url' => CController::createUrl('employees/attendanceReportDailyView'),
                        'beforeSend' => 'function(){
