...
$form = $this->beginWidget('CActiveForm', array(
            ...
            'action' => $this->createUrl('ahProllNormal/create'),
...
<div class="formDiv">
    ...
    <fieldset class="tblFooters">
        ...
        <?php
        echo CHtml::ajaxSubmitButton('Add', CHtml::normalizeUrl(array('ahProllNormal/create', 'render' => true)), array(
            'dataType' => 'json',
            'type' => 'post',
            'success' => 'function(data) {
                    ...
                    if(data.status=="success"){
                        ...
                        $("#ah-proll-normal-form")[0].reset();
                        $("#formResult").animate({opacity:1.0},1000).fadeOut("slow");
                        $.fn.yiiGridView.update("ah-proll-normal-grid", {
		data: $(this).serialize()
	});
                    }else{
                        //$("#formResultError").html("Data not saved. Pleae solve the following errors.");
                        $.each(data, function(key, val) {
                            $("#ah-proll-normal-form #"+key+"_em_").html(""+val+"");                                                    
                            $("#ah-proll-normal-form #"+key+"_em_").show();
                        });
                    }       
                }',
            'beforeSend' => 'function(){                        
