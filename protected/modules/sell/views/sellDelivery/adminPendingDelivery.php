...
<?php
if (Yii::app()->user->checkAccess('Sell.SellOrder.VoucherPreview')) {
    ?>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Manage Pending Delivery</h3>
    ...
    <div class="card-body">
        <?php $this->widget('ext.groupgridview.GroupGridView', array(
            'id' => 'sell-order-grid',
            'dataProvider' => $model->searchPendingDelivery(),
            'filter' => $model,
            'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview/styles.css',
            'mergeColumns' => array('order_type', 'date', 'customer_id',),
...
//                'id',
                ...
                (
                    ...
                    'class' => 'CButtonColumn',
                    'htmlOptions' => ['style' => 'width: 100px', 'class' => 'text-center'],
                    'buttons' => array(
                        'delivery' => array(
