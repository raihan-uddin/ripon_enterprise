...
//             'title' => 'Report generated by: '.Yii::app()->user->name. ' ' . ' =====  ' .Yii::app()->name.'',
            ...
            $order = SellOrder::model()->findByPk($data->sell_order_id);
            ?>
        </div>
        <div class='printAllTableForThisReport' style="width: 8.5in;">
            <table style="width: 100%; border-collapse: collapse; font-size: 11px;" class="item-list">
                <tr>
                    <td colspan="2"><img src="<?= Yii::app()->theme->baseUrl . "/images/logo.png" ?>"
                                         style="width: 100%; height: 100px;"></td>
                    <td style="text-align: center;"><h5>DELIVERY CHALLAN</h5></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
                            ...
                            <tr>
                                <td style="text-align: center;"><b>Delivery No</b></td>
                                <td style="text-align: center;"><b>Customer Code</b></td>
                            </tr>
                            <tr>
                                <td style="text-align: center;"><?= "$data->delivery_no" ?></td>
                ...
                <tr>
                    ...
                    <td style="text-align: center;  width: 30%;">Qty</td>
                </tr>
                <tbody>
                <?php
                ...
                $data2 = SellDeliveryDetails::model()->findAll($criteria);
                if ($data2) {
                    $i = 1;
                    foreach ($data2 as $dt) {
                        ?>
                ...
                ?>
                <tr>
                    <td colspan="3" style="height: 150px; vertical-align: bottom; text-align: left;">
