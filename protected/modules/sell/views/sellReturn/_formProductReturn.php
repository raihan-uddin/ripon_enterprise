...
.pr-fl{position:relative;margin-bottom:16px}
...
/* ── Select fields ── */
.pr-select-group{margin-bottom:16px}
...
.pr-btn-success{background:linear-gradient(135deg,#10b981,#059669);color:#fff;border:none;border-radius:8px;padding:9px 14px;font-size:13px;font-weight:600;cursor:pointer;box-shadow:0 2px 8px rgba(16,185,129,.3);transition:transform .15s}
.pr-btn-success:hover{transform:translateY(-1px);color:#fff}
.pr-btn-danger{background:linear-gradient(135deg,#ef4444,#dc2626);color:#fff;border:none;border-radius:8px;padding:9px 14px;font-size:13px;font-weight:600;cursor:pointer;box-shadow:0 2px 8px rgba(239,68,68,.3);transition:transform .15s}
...
.pr-table tbody td{padding:8px 12px;border-bottom:1px solid #f1f5f9;vertical-align:middle}
...
@media(max-width:992px){.pr-grid-4,.pr-grid-3,.pr-grid-items{grid-template-columns:1fr 1fr}.pr-action-col{grid-column:span 2}}
@media(max-width:576px){.pr-grid-4,.pr-grid-3,.pr-grid-items{grid-template-columns:1fr}}

/* ── Misc ── */
.pr-remarks{width:100%;border:1.5px solid #e2e8f0;border-radius:8px;padding:12px;font-size:13px;color:#1e293b;outline:none;resize:vertical;min-height:60px;transition:border-color .2s,box-shadow .2s}
...
.pr-inner-header{background:linear-gradient(135deg,#eef2ff,#e0e7ff);padding:12px 20px;display:flex;align-items:center;justify-content:space-between}
...
.pr-inner-body{padding:18px 20px;background:#fff}
</style>
        ...
        <div class="pr-card-body">
            ...
            <div class="pr-grid pr-grid-4">
                ...
                <div class="pr-fl">
                    ...
                    <?php echo $form->error($model, 'sell_id', array('class' => 'pr-error')); ?>
                </div>
                ...
                <div class="pr-inner-body">
                    <div class="pr-grid pr-grid-items" style="align-items:end">
                        ...
                        <div class="pr-fl pr-fl-no-icon" style="margin-bottom:0">
                            <?php echo $form->textField($model2, 'qty', array('maxlength' => 255, 'class' => 'pr-fl-input numeric-validation qty', 'placeholder' => ' ')); ?>
                        ...
                        <!-- Sell Price -->
                        <div class="pr-fl pr-fl-no-icon" style="margin-bottom:0">
                            <?php echo $form->textField($model2, 'sell_price', array('maxlength' => 255, 'class' => 'pr-fl-input numeric-validation sell-price', 'placeholder' => ' ')); ?>
                            <?= $form->hiddenField($model2, 'purchase_price', array('class' => 'form-control costing-amount')); ?>
                            <label class="pr-fl-label">Sell Price</label>
                            <?php echo $form->error($model2, 'sell_price', array('class' => 'pr-error')); ?>
                        </div>

                        <!-- Row Total -->
                        <div class="pr-fl pr-fl-no-icon" style="margin-bottom:0">
                            <?php echo $form->textField($model2, 'row_total', array('maxlength' => 255, 'class' => 'pr-fl-input row-total-amount', 'placeholder' => ' ')); ?>
