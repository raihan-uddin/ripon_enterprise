                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-sm table-valign-middle table-sticky table-compact"
                            ...
                            $criteria->select = "
                                ...
                                companies.name AS company_name, prod_items.item_name,
                            ...
                            $criteria->join = "
                                ...
                                LEFT JOIN prod_items on t.item_id = prod_items.id
                            ";
                            $criteria->group = "t.id";
                            $criteria->order = "companies.name ASC, prod_items.item_name ASC, t.brand_id ASC, t.model_name ASC";
                                ...
                                <tr class="company-<?= $groupIndex ?> item hidden">
                                    ...
                                    <td data-label="Product">
                                        ...
                                        <span style="font-size:11px; color:#fff;">
                                            ...
                                            <span style="color:#444;"><?php echo $item->item_name; ?></span>
                                        </span>
        ...
        try {
            ...
            if (hasRows) {
                ...
                $.each(restoredGroups, function (groupClass) {
                    ...
                    $('[data-bs-target="' + groupClass + '"]').find('.toggle-icon').text('▲');
                });
