        ...
        <div class='printAllTableForThisReport' style="width: 8.5in;">
            <table style="width: 100%; border-collapse: collapse; font-size: 11px;" class="item-list">
                <tr>
                    ...
                    <td style="text-align: center;" colspan="2"><h3>PRODUCTION ORDER</h3></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: 10%;">Color</td>
                ...
                if ($data2) {
                    ...
                    foreach ($data2 as $dt) {
                        ...
                        <tr>
                            ...
                            <td><img src="<?= Yii::app()->baseUrl . "/uploads/products/$dt->image" ?>"
