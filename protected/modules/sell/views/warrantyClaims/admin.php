		...
		array(
			...
			'buttons' => array(
				'view' => array(
					...
					'imageUrl' => false,
					'options' => array('class' => 'action-btn btn-view', 'rel' => 'tooltip', 'data-bs-toggle' => 'tooltip', 'title' => 'View'),
				),
				'update' => array(
				...
				'delete' => array(
					...
					'imageUrl' => false,
					'options' => array('class' => 'action-btn btn-delete', 'rel' => 'tooltip', 'data-bs-toggle' => 'tooltip', 'title' => 'Delete'),
				),
			),
		),
	),
