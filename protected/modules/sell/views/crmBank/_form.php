...
$form = $this->beginWidget('CActiveForm', array(
    'id' => 'crm-bank-form',
    'action' => $this->createUrl('crmBank/create'),
...
<style>
/* ── cb- design system (crmBank _form) ────────────────────────── */
.cb-card {
    border: none;
    border-radius: 16px;
    overflow: hidden;
...
.cb-fl-wrapper:focus-within .cb-fl-icon {
    color: #6366f1;
}
.cb-fl-label {
    position: absolute;
...
<div class="cb-card">
    <div class="cb-header">
        <div class="cb-header-left">
            ...
            <div>
                ...
                <div class="cb-header-subtitle"><?php echo($model->isNewRecord ? 'Register a new bank account' : 'Edit bank details'); ?></div>
            </div>
        </div>
    ...
    <div class="cb-footer">
        <?php
        echo CHtml::ajaxSubmitButton('Save', CHtml::normalizeUrl(array('crmBank/create', 'render' => true)), array(
            'dataType' => 'json',
            'type'     => 'post',
            'success'  => 'function(data) {
                ...
                if (data.status == "success") {
                    ...
                    $.each(data, function(key, val) {
                        $("#crm-bank-form #"+key+"_em_").html(""+val+"");
                        $("#crm-bank-form #"+key+"_em_").show();
                    });
                }
            }',
            'beforeSend' => 'function(){
