...
<style>
    ...
    /* ── Filter row inputs ── */
    #loan-transactions-grid .filters input,
    #loan-transactions-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #loan-transactions-grid .filters input:focus,
    #loan-transactions-grid .filters select:focus {
        border-color: #17a2b8;
    ...
    /* ── Grid rows ── */
    #loan-transactions-grid td {
        vertical-align: middle;
        font-size: 13px;
        padding: 7px 10px;
    }

    #loan-transactions-grid tr:hover td {
                ...
                'columns' => array(
                        ...
                        [
                                ...
                                'value' => 'CHtml::tag(
                                    ...
                                    [
                                        "class" => "badge " . 
                                        ($data->transaction_type === "lend" ? "bg-danger" : "bg-success")
                                    ],
