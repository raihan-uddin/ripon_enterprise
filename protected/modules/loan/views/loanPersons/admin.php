...
<style>
    ...
    /* ── Filter row inputs ── */
    #loan-person-grid .filters input,
    #loan-person-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #loan-person-grid .filters input:focus,
    #loan-person-grid .filters select:focus {
        border-color: #17a2b8;
...
function goToPage() {
    ...
    $.fn.yiiGridView.update('loan-person-grid', { data: { 'loan-person-grid_page': page } });
    $('#goto-page-input').val('');
}
