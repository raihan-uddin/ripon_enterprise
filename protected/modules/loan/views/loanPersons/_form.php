...
/* header */
.lp-card-header{background:linear-gradient(135deg,#4f46e5 0%,#7c3aed 100%);padding:20px 26px;position:relative;overflow:hidden}
...
.lp-header-row{display:flex;align-items:center;gap:12px;position:relative;z-index:1}
...
/* body */
.lp-card-body{padding:22px 26px;background:#fff}

/* footer */
.lp-card-footer{background:#f8fafc;border-top:1px solid #f1f5f9;padding:14px 26px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px}
.lp-card-footer small{font-size:12px;color:#94a3b8}
.lp-card-footer small span{color:#ef4444}

/* floating-label group */
.lp-fl{position:relative;margin-bottom:18px}
...
/* textarea variant */
.lp-fl .lp-fl-input[rows]{padding-top:24px;min-height:80px;resize:vertical}
...
/* select group */
.lp-select-group{margin-bottom:18px}
...
/* row helper */
.lp-row{display:flex;flex-wrap:wrap;gap:0 20px}
.lp-col-half{flex:1 1 calc(50% - 10px);min-width:240px}
        ...
        <div class="lp-header-row">
            ...
            <div>
                ...
                <div class="lp-header-sub">
                    <?= $model->isNewRecord ? 'Register a new person for loan tracking' : 'Modify person details'; ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="lp-card-footer">
        ...
        <div style="display:flex;align-items:center;gap:10px">
            ...
            echo CHtml::ajaxSubmitButton(
                    ...
                    ['class' => 'lp-submit', 'id' => 'lp-submit-btn']
            );
            ?>

            <span id="ajaxLoader" class="lp-loader">
