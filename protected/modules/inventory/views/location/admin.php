...
$this->widget('application.components.BreadCrumb', array(
    'crumbs' => array(
        ...
        array('name' => 'Location', 'url' => array('admin')),
        array('name' => 'Manage'),
    ),
//    'delimiter' => ' &rarr; ',
));
...
if (Yii::app()->user->checkAccess('Inventory.Location.Create')) {
...
<style>
    ...
    /* ── Filter row inputs ── */
    #location-grid .filters input,
    #location-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #location-grid .filters input:focus,
    #location-grid .filters select:focus {
        border-color: #17a2b8;
...
function goToPage() {
    ...
    $.fn.yiiGridView.update('location-grid', { data: { 'location-grid_page': page } });
    $('#goto-page-input').val('');
}
