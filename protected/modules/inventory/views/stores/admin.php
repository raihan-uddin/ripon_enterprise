...
$this->widget('application.components.BreadCrumb', array(
    'crumbs' => array(
        ...
        array('name' => 'Stores', 'url' => array('admin')),
        array('name' => 'Manage'),
    ),
));

if (Yii::app()->user->checkAccess('Inventory.Stores.Create')) {
...
<style>
    ...
    /* ── Filter row inputs ── */
    #stores-grid .filters input,
    #stores-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #stores-grid .filters input:focus,
    #stores-grid .filters select:focus {
        border-color: #17a2b8;
...
function goToPage() {
    ...
    $.fn.yiiGridView.update('stores-grid', { data: { 'stores-grid_page': page } });
    $('#goto-page-input').val('');
}
