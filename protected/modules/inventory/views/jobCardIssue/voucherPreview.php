        ...
        <div class='printAllTableForThisReport' style="width: 8.5in;">
            <table style="width: 100%; border-collapse: collapse; font-size: 11px;" class="item-list">
                <tr>
                    <td colspan="3" style="vertical-align: middle;">
                        ...
                        <div style="width: 29%; float: right; vertical-align: middle; text-align: center;">
                            <h3 style="vertical-align: middle;">JOB CARD ISSUE</h3>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="border-right: white;">
                        <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
                            <tr>
                                <td style="text-align: center;"><b>Issue No</b></td>
                                <td style="text-align: center;"><?= "$data->job_card_no" ?></td>
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: 20%;">Issue Qty</td>
                </tr>
                <?php
                $criteria = new CDbCriteria();
                $criteria->select = "t.*, pm.model_name, pm.code, pm.image";
                $criteria->join = " INNER JOIN prod_models pm on t.model_id = pm.id ";
                $criteria->addColumnCondition(['t.job_card_issue_id' => $data->id]);
                $criteria->order = "pm.model_name ASC";
                $data2 = JobCardIssueDetails::model()->findAll($criteria);
                $row_total = 0;
                if ($data2) {
                    $i = 1;
                    foreach ($data2 as $dt) {
