...
<style>
    ...
    /* ── Filter row inputs ── */
    #prod-brands-grid .filters input,
    #prod-brands-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #prod-brands-grid .filters input:focus,
    #prod-brands-grid .filters select:focus {
        border-color: #17a2b8;
...
<?php
if (Yii::app()->user->checkAccess('ProdBrands.Create')) {
...
function goToPage() {
    ...
    $.fn.yiiGridView.update('prod-brands-grid', { data: { 'prod-brands-grid_page': page } });
    $('#goto-page-input').val('');
}
