...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('sell-price-grid', {
		data: $(this).serialize()
	});
	return false;
});
");
?>
<?php echo CHtml::link('Back', array('/prodModels/adminSellPrice'), array('class' => 'btn btn-danger mb-2 mt-2')); ?>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Manage Sale Price</h3>
...
//            ),
            ...
            'columns' => array(
                array(
                    'name' => 'model_id',
                    'value' => 'CHtml::encode(ProdModels::model()->modelName($data->model_id))',
//                'filter' => CHtml::listData(ProdModels::model()->findAll(), 'id', 'model_name'),
                ),
                'sell_price',
                'discount',
                'start_date',
                ...
                (
                    ...
                    'buttons' => array(
                        'update' => array(
                            ...
                            $( '#update-dialog' )
                              .dialog( { title: 'Update Sell Price Info' } )
                              .dialog( 'open' ); }",
                        ),
                        'delete' => array(
