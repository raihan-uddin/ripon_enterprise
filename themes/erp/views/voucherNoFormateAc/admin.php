...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('voucher-no-formate-ac-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Manage Number Format</h3>
...
//        'template' => "{pager}{summary}{items}{summary}{pager}",
        'columns' => array(
            array(
                'name' => 'type',
                'value' => 'LookupAc::item("voucher_type", $data->type)',
                'filter' => LookupAc::items('voucher_type'),
            ),
            'type_format',
            array
                (
