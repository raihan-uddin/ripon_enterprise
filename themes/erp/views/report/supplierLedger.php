...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Search Conditions (SUPPLIER LEDGER)</h3>
    ...
    <div class="card-footer">
        ...
        echo CHtml::submitButton('Search', array(
                'ajax' => array(
                    'type' => 'POST',
                    'url' => CController::createUrl('/report/supplierLedgerView'),
                    'beforeSend' => 'function(){
                                if($("#Inventory_date_from").val()=="" || $("#Inventory_date_to").val()==""){
                                    toastr.error("Warning! Please select date range!");
                                    return false;
                                }else if($("#Inventory_supplier_id").val()==""){
                                    toastr.error("Warning! Please select supplier!");
                                    return false;
                                }else{
...
<script>
    ...
    function clearProduct() {
        $("#supplier_id_text").val("");
        $("#Inventory_supplier_id").val("");
    }
</script>
