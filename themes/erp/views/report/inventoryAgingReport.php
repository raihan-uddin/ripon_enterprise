...
$this->widget('application.components.BreadCrumb', array(
        'crumbs' => array(
                ...
                array('name' => 'Inventory Aging Report', 'url' => array('report/inventoryAgingReport')),
        ),
));
?>
<?php
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Search Conditions (Inventory Aging Report)</h3>
    ...
    <div class="card-footer">
        ...
        echo CHtml::submitButton('Search', array(
                        'ajax' => array(
                                'type' => 'POST',
                                'url' => CController::createUrl('/report/inventoryAgingReportView'),
                                'beforeSend' => 'function(){
