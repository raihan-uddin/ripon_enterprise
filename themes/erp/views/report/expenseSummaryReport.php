...
$this->widget('application.components.BreadCrumb', array(
    'crumbs' => array(
        ...
        array('name' => 'Expense Summary Report (Day Wise)',),
    ),
//    'delimiter' => ' &rarr; ',
));
?>
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Search Conditions (EXPENSE SUMMARY REPORT)</h3>
    ...
    <div class="card-footer">
        ...
        echo CHtml::submitButton('Search', array(
                'ajax' => array(
                    'type' => 'POST',
                    'url' => CController::createUrl('/report/expenseSummaryReportView'),
                    'beforeSend' => 'function(){
