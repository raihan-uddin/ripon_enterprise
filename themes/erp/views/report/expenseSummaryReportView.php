...
<div class='printAllTableForThisReport table-responsive p-0'>
    <table class="summaryTab final-result table2excel table2excel_with_colors table table-bordered table-sm"
        ...
        <tr class="titlesTr sticky">
            ...
            <th style="width: 10%; box-shadow: 0px 0px 0px 1px black inset;">Entry No</th>
        ...
        if ($data) {
            foreach ($data as $dmr) {
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><?php echo $dmr->entry_no; ?></td>
                    <td style="text-align: left;"><?php echo sprintf("%s", $dmr->remarks); ?></td>
