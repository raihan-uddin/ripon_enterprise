...
$this->widget('application.components.BreadCrumb', array(
        'crumbs' => array(
                ...
                array('name' => 'Non Moving Stock Report', 'url' => array('report/deadStockReport')),
        ),
));
?>
<?php
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Search Conditions (DEAD / NON-MOVING STOCK)</h3>
    ...
    <div class="card-footer">
        ...
        echo CHtml::submitButton('Search', array(
                        'ajax' => array(
                                'type' => 'POST',
                                'url' => CController::createUrl('/report/deadStockReportView'),
                                'beforeSend' => 'function(){
