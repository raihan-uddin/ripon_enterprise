...
<style>
    ...
    /* ── Filter row inputs ── */
    #prod-items-grid .filters input,
    #prod-items-grid .filters select {
        width: 100%;
        font-size: 12px;
        height: 28px;
        padding: 2px 6px;
    ...
    #prod-items-grid .filters input:focus,
    #prod-items-grid .filters select:focus {
        border-color: #17a2b8;
...
function goToPage() {
    ...
    $.fn.yiiGridView.update('prod-items-grid', { data: { 'prod-items-grid_page': page } });
    $('#goto-page-input').val('');
}
